...
private float returnsRating=0;
private double returnsDateInsri=0;
private double returnsClassification=0;
private double returnsnbPortfolios=0;
...
private List<AssetManager> listeBan = new ArrayList<>();

public List<AssetManager> getListeBan() {
	listeBan=es.BanAM();
	return listeBan;
}


public void setListeBan(List<AssetManager> listeBan) {
	this.listeBan = listeBan;
}
...
public String updateAssetManager(int id) {

	
	setIdUp(id);
	AssetManager Vh=es.getAssetManagerById(id);
...
public String Rating()
{
	...
	return "/Template/RatingAM?faces-redirect=true";
