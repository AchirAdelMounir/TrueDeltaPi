...
//	void pdfs() throws Exception;
	...
	Object GetContractBYAmount(Double IDContract);

	Object GetAmountByContratId(int IDContract);

	List<Object[]> GetContractBYStartDate(Date StartDate);

	List<Object[]> GetContractBYEndDate(Date EndDate);

	void pdfs(int id) throws SQLException;

	void pdfs() throws SQLException;

	void SmsSenderAdmin(String msg);

	void SmsSenderAM(String msg);

	void affecterClientToContract(int idClient);
